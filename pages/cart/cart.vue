<template>
	<view class="container">
		...
		<view v-if="!hasLogin || empty===true" class="empty">
			...
			<view v-if="hasLogin" class="empty-tips">空空如也
				<navigator class="navigator" v-if="hasLogin" url="../index/index" open-type="switchTab">随便逛逛></navigator>
			</view>
			<view v-else class="empty-tips">空空如也
	...
	export default {
		...
		methods: {
			...
			createOrder(){
				...
				uni.navigateTo({
					url: `/pages/order/createOrder?list=${JSON.stringify({goodList})}&total=${this.total}&cartIdList=${JSON.stringify({cartIdList})}`
				})
			}
		}
	}
